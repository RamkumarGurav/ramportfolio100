  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`SIDEBAR_CONT relative   ||| bg-xgraydark  ||| min-h-full       `}
      >
        <motion.div
          ...
          bg-xgraydark  text-white  ||| ${!isSidebarOpen && "hidden"} `}
        >
          <div
          ...
          <div className="p-4  ||| flex items-center gap-2  |||  border-b border-b-gray-600">
